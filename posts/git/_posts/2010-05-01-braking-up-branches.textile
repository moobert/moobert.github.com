---
layout: post
title: braking up git branches
---

I've resently needed to divide a branch into two parts. The process involved checking out at the commit to wished divide at and then creating a new branch at this point. The last step was then just a matter of renaming the new branches to fit the name scheme I wanted.
